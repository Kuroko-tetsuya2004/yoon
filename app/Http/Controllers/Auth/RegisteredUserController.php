...
class RegisteredUserController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        $request->validate([
            ...
            'moyen_transport' => ['nullable', 'string', 'in:camionnette,tricycles,voiture de transport de bagages'],
            'immatriculation' => ['nullable', 'string', 'max:255', 'required_if:role,livreur'],

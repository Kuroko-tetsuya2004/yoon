        ...
        if (commande.statut === 'en_livraison' && commande.livraison?.livreur && mapRef.current) {
            ...
            if (livreurLat && livreurLng && clientLat && clientLng) {
                ...
                const interval = setInterval(() => {
                    // Fetch real-time position of the livreur
                    fetch(route('partenaire.commandes.livreur_location', commande.id))
                        .then(res => res.json())
                        .then(data => {
                    ...
                    >
                        <div className="p-8">
                            <div className="flex justify-between items-center mb-6">
                                ...
                                <Link 
                                    href={route('partenaire.commandes.index')}
                            ...
                            <div className="bg-blue-50 border-l-4 border-blue-500 p-6 rounded-lg mb-8">
                                ...
                                {commande.statut === 'en_livraison' ? (
                                    ...
                                    <div className="mt-8 bg-white p-8 rounded-lg text-center border border-gray-100">
                                        ...
                                        <p className="text-gray-500">Le suivi GPS s'affichera ici dès que le livreur sera en route vers le client.</p>
                                    </div>
                                )}
                            </div>
                        </div>
